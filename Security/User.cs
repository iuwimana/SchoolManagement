...
{
    /// <summary>
    /// Represents a system user jjgjhhjjhkjjhkjk
    /// </summary>
    public class User
    {
        ...
        public string UserLocationDistrict { get; set; }
        public string UserLocationProvince { get; set; }
        public bool Active { get; set; }
        public int? StaffID { get; set; }
        public string RoleList { get; set; }
        public int workingArrearID { get; set; }
        public string workingArrear { get; set; }
    ...
    public class Users : ICollection<User>
    {
        ...
        public void Load()
        {
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    user.RoleListID = DBUtility.SafeGet<Int32>(dr, "RoleListID");
                    user.workingArrear= DBUtility.SafeGet<string>(dr, "workingArrear");
        ...
        public void LoadArrear(int UserID)
        {
            try
            {
                SqlDataReader dr = DBAccess.MISDB.ExecuteReader("GetWinClientUsers", "UserID", UserID);
                ...
                while (dr.Read())
                {
                    ...
                    user.RoleListID = DBUtility.SafeGet<Int32>(dr, "RoleListID");
                    user.workingArrear = DBUtility.SafeGet<string>(dr, "workingArrear");
                    user.workingArrearID=Convert.ToInt32(dr["workingArrearID"]);
        ...
        public void Loadweb()
        {
            try
            {
                SqlDataReader dr = DBAccess.MISDB.ExecuteReader("GetWebClientUsers");
                ...
                while (dr.Read())
                {
                    ...
                    user.RoleList = DBUtility.SafeGet<string>(dr, "RoleList");
                    user.RoleListID = DBUtility.SafeGet<Int32>(dr, "RoleListID");
                    user.UserLocationDistrict = Convert.ToString(dr["UserLocationDistrict"]);
                    user.UserLocationProvince = Convert.ToString(dr["UserLocationProvince"]);
